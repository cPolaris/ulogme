...
Current todo: improve the way things are logged. The current way of repeatedly creating and removing temporary files looks pretty silly and probably won't do good to an SSD. And instead of ad-hoc text file, we can use sqlite.

Otherwise, Karpathy really nailed this lovely tool, especially the way the data is presented.
